...
@section('content')
    ...
    <div class="flex mb-5 gap-4 flex-wrap justify-between">
        <button type="button" onclick="tambahFilm()"
        ...
        <label class="block text-xs">
            <form action="/cari-film" method="GET">
    ...
    <a href="/tambah-film" id="tf" hidden></a>
    <div class="w-full mb-4 overflow-hidden rounded-lg shadow-xs">
            ...
            <table class="w-full whitespace-no-wrap">
                <thead>
                    <tr
                        ...
                        <th class="px-4 py-3">Kode Filem</th>
                        <th class="px-4 py-3">Jenis Film</th>
                        <th class="px-4 py-3">Aksi</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach ($dt_film as $k => $i)
        ...
        <div
            ...
            <span class="flex items-center col-span-3">
                Showing {{ $dt_film->firstItem() }} - {{ $dt_film->lastItem() }} of {{ $dt_film->total() }}
            </span>
            <span class="col-span-2"></span>
            <!-- Pagination -->
            {{ $dt_film->links('layouts.pagination') }}
        </div>
    </div>
@endsection
